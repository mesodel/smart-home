...
class HumidityLayout extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      height: 0,
  ...
  render() {
    ...
    if (this.state.sensorDataToday && this.state.sensorDataToday.length > 0) {
      ...
      let record = this.state.sensorDataToday[
        this.state.sensorDataToday.length - 1
      ].value;
      if (record && record > 30 && record < 50) {
        review = "IDEAL";
      } else if (record && record < 30) {
        review = "DRY";
      } else if (record && record > 50) {
        review = "TOO DRY";
      }
    }
    ...
    return (
      ...
      >
        <Helmet>
          <title>{"Humidity - " + this.props.sensor.name}</title>
        </Helmet>
        <div
          id="firstRow"
          style={{
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <span style={{ fontSize: "0.75em" }}>{review}</span>
